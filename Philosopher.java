...
public class Philosopher extends BaseThread
{
	...
	public void think()
	{
		try{
			...
			sleep((long)(Math.random() * TIME_TO_WASTE));
			System.out.println(this.getTID() + " is done thinking.");
		}
		catch(InterruptedException e){
	...
	public void run()
	{
		...
		{
			/* Philosopher must pick up chopsticks before eating, and put them down afterwards*/
			...
			{
				/* Philosophers must request to speak before speaking, as only one can speak at a time. */
